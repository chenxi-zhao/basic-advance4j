package com.chenxi.distributes.distributeId;

/**
 * Created by chenxi on 2017/9/14.
 * <p>
 ...
 * 41位的时间截，可以使用69年，年T = (1L << 41) / (1000L * 60 * 60 * 24 * 365) = 69.7<br>
 * <p>
 * 10位的数据机器位，可以部署在1024个节点，包括5位datacenterId和5位workerId<br>
 * <p>
 * 12位序列，毫秒内的计数，12位的计数顺序号支持每个节点每毫秒(同一机器，同一时间截)产生4096个ID序号, 加起来刚好64位，为一个Long型。<br>
 * <p>
...
public class SnowflakeIdWorker {
    ...
    public SnowflakeIdWorker(long workerId, long datacenterId) {
        ...
        // 验证存储的最小时间戳，保证server服务启动时，如果系统的时间被回拨，能够检测并抛出异常
    ...
    public synchronized long nextId() {
        ...
        if (lastTimestamp == timestamp) {
            // sequenceMask为4095，如果该计算为0，则表示序列码超过指定（12）位
     ...
     */
    private void validateTimestamp(long timestamp, long lastTimestamp) throws IllegalStateException {
